...
router.get('/paying-receiving', (req, res) => {
    res.render('v9/paying-receiving')
})
...
router.get('/are-both-parents-habitually-resident-in-the-uk', (req, res) => {
    res.render('v9/habitually-resident.njk')
})
