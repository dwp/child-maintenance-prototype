...
router.get('/are-both-parents-habitually-resident-in-the-uk', (req, res) => {
    res.render('alpha-prototype-2/questions/habitually-resident.njk')
})
...
router.get('/is-there-a-court-order-for-child-maintenance-in-place', (req, res) => {
    res.render('alpha-prototype-2/questions/court-order.njk')
})
...
router.get('/is-child-under-20', (req, res) => {
    res.render('alpha-prototype-2/questions/child-age.njk')
})
...
router.get('/what-information-do-you-have-about-the-other-parent', (req, res) => {
    res.render('alpha-prototype-2/questions/other-parent.njk')
})
...
router.get('/in-contact', (req, res) => {
    res.render('alpha-prototype-2/questions/in-contact.njk')
})
...
router.get('/domestic-abuse', (req, res) => {
    res.render('alpha-prototype-2/questions/abuse.njk')
})
...
router.get('/fba', (req, res) => {
    res.render('alpha-prototype-2/questions/fba.html')
})
